...
static void sdiom_launch_thread(void)
{
	...
	if (task_tx_core != 0)
		...
		sdiom_err("sdiom, create tx_core_thread fail\n");
		return;
	}
	...
	if (task_tx_trans != 0)
		...
		sdiom_err("sdiom, tx_trans_thread create fail\n");
		return;
	}
	...
	if (task_rx_core != 0)
		...
		sdiom_err("sdiom, rx_core_thread create thread fail\n");
		return;
	}
	...
	if (task_rx_trans != 0)
		...
		sdiom_err("sdiom, tx_core_trans create thread fail\n");
		return;
	}
}
